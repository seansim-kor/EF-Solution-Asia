      ...
      React.createElement('div', { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" },
        ...
        React.createElement('div', { className: "mt-12 grid gap-10 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-12 items-center" },
          ...
          React.createElement('div', { className: "mt-10 lg:mt-0" },
              React.createElement('img', { className: "rounded-lg shadow-xl", src: "public/farmer-in-field.jpg", alt: "A farmer standing in a lush, healthy field, symbolizing prosperity and sustainable agriculture" })
          )
        )
      )
    )
    ...
    React.createElement('section', { id: "technology", className: "py-20 bg-brand-off-white text-brand-gray" },
      React.createElement('div', { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" },
        ...
        React.createElement('div', { className: "mt-16 grid md:grid-cols-2 gap-12 items-center" },
            ...
            React.createElement('div', {},
                React.createElement('img', { className: "rounded-lg shadow-xl", src: "public/scientist-with-plant.jpg", alt: "Scientist examining a plant in a high-tech lab" })
            )
        )
      )
    )
