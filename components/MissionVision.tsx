      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-12 items-center">
          ...
          <div className="mt-10 lg:mt-0">
              <img className="rounded-lg shadow-xl" src="/farmer-in-field.jpg" alt="A farmer standing in a lush, healthy field, symbolizing prosperity and sustainable agriculture"/>
          </div>
        </div>
      </div>
    </section>
